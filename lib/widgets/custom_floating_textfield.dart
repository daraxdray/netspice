...
// Custom floating text field widget
...
class CustomFloatingTextField extends StatelessWidget {
 ...
 @override
  ...
  InputDecoration get decoration => InputDecoration(
    hintText: hintText ?? "",
    hintStyle: hintStyle ?? CustomTextStyles.bodyMedium,
    labelText: labelText ?? "",
...
class CustomOutlinedInputBorder extends InputBorder {
  const CustomOutlinedInputBorder({
    super.borderSide,
    this.borderRadius = const BorderRadius.all(Radius.circular(4.8)),
    this.borderGradient,
    this.fillGradient,
  });
  ...
  ShapeBorder? lerpFrom(
    ...
    if (a is CustomOutlinedInputBorder) {
      ...
      return CustomOutlinedInputBorder(
        ...
        borderSide: BorderSide.lerp(outline.borderSide, borderSide,
 t),
  ...
  ShapeBorder? lerpTo(
    ...
    if (b is CustomOutlinedInputBorder) {
      ...
      return CustomOutlinedInputBorder(
        ...
        borderSide: BorderSide.lerp(borderSide, outline.borderSide, 
 t),
        borderGradient: outline.borderGradient,
        fillGradient: outline.fillGradient,
      );
  ...
  @override
  void paint(Canvas canvas, Rect rect, {double? gapStart, double gapExtent = 0.0, double gapPercentage 
 = 0.0, TextDirection? textDirection}) {
